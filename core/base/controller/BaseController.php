...
abstract class BaseController{ //подключает методы для вытаскивания данных, обращается к моделям
    ...
    protected function init($admin = false) { // инициализация js и css файлов
